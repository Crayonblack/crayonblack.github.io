...
const AppRoot = class {
    ...
    hideLine(number) {
        if (number === 1) {
            gsapWithCSS.to(this.line1, { duration: 1, delay: 7, opacity: 0, ease: "expoScale" });
        }
        else {
            gsapWithCSS.to(this.line2, { duration: 1, delay: 3, opacity: 0, });
        }
    }
    hideJourney() {
        this.intro.remove();
    ...
    launchCV() {
        ...
        gsapWithCSS.to(this.line3, { duration: 2, delay: 0.2, y: -100, opacity: 0, scale: 0, ease: "expoScale" });
        gsapWithCSS.to(this.look, { duration: 2, delay: 0.5, opacity: 0, y: 100, ease: "expoScale" });
        gsapWithCSS.to(this.circle1, { duration: 4, delay: 1, scale: 6, opacity: 0, ease: "expoScale", });
        gsapWithCSS.to(this.circle2, { duration: 4, delay: 0.9, scale: 5, opacity: 0, ease: "expoScale", });
        gsapWithCSS.to(this.circle3, { duration: 4, delay: 0.8, scale: 4, opacity: 0, ease: "expoScale", });
        gsapWithCSS.to(this.circle4, { duration: 4, delay: 0.7, scale: 3, opacity: 0, ease: "expoScale", onComplete: () => this.hideJourney() });
    ...
    render() {
        return (h("section", { key: '25ec636efeb762fb7b3a6eb0693d3d03aec30932', id: "wrapper", class: "wrapper relative overflow-hidden w-screen h-screen", style: { "background-image": "url('./assets/texture.jpg')" } }, h("section", { key: '38253f174e75d411f787c6809d6741d21b21969c', id: "cvbg", class: "opacity-0 cvbg absolute w-screen h-screen flex items-end gap-[2%]", style: { "background-image": "url('./assets/cvbg.jpg')" } }, h("section", { key: '2516324701fb90b285f3db2de1c7bc1eed70fad1', id: "about", class: "about relative z-10" }, h("article", { key: 'c9b0e5939a4c724176cda38e3c9a26d41bc4f411' }, h("p", { key: '9d31159437734007e2fe30edb552849e3218d516', "data-id": "1" }, "Hello there, my name is Craig du Toit and I am a Front-End Engineer and as you can clearly see, I have a passion for animation and interactivity on the web."), h("p", { key: '21c4791161def4df903168eed2264fd1307680c6', "data-id": "2" }, "I have been working in the industry for 15 years and this serves as not only a demonstration of my craft but also a breakdown of my recent work history, responsibilities, tech stack and hobbies."), h("p", { key: '2f1388af4621452422b28d8f6a304ab0889e44da', "data-id": "3" }, "I aspire to be a dependable and ever eager colleague, a loving husband, a good father to my son - a 2 and half year sweetheart in the hieght of the terrible twos and our newborn due in May 2026."), h("p", { key: 'a9fdb53e17e545d850fc56fff336b5560d40855a', "data-id": "4" }, "My hobbies include running, playing padel with good friends and enjoying some seriously good food. I am a social and well-spoken person and that doesn't have a hard time making lifelong friends."), h("div", { key: '31212fb96262b2dc11ba06bb6e4fadbbfef24402', id: "socials", class: "socials flex gap-2" }, h("a", { key: '4d2bc1bb8cbc6cf3664221e689f3014e9860bfe5', href: "https://www.linkedin.com/in/craigddutoit/", target: "_blank" }, h("svg", { key: '69ec45ad6e4ea3d607c53324756f2bc09cc72318', id: "linkedin", class: "translate-y-100", xmlns: "http://www.w3.org/2000/svg", width: "36", height: "36", viewBox: "0 0 256 256" }, h("path", { key: 'f0530c1501bee658d0c2f846c813c8dfe4a51e01', fill: "#480eff", d: "M218.123 218.127h-37.931v-59.403c0-14.165-.253-32.4-19.728-32.4c-19.756 0-22.779 15.434-22.779 31.369v60.43h-37.93V95.967h36.413v16.694h.51a39.91 39.91 0 0 1 35.928-19.733c38.445 0 45.533 25.288 45.533 58.186zM56.955 79.27c-12.157.002-22.014-9.852-22.016-22.009s9.851-22.014 22.008-22.016c12.157-.003 22.014 9.851 22.016 22.008A22.013 22.013 0 0 1 56.955 79.27m18.966 138.858H37.95V95.967h37.97zM237.033.018H18.89C8.58-.098.125 8.161-.001 18.471v219.053c.122 10.315 8.576 18.582 18.89 18.474h218.144c10.336.128 18.823-8.139 18.966-18.474V18.454c-.147-10.33-8.635-18.588-18.966-18.453" })))))), h("section", { key: 'a3f0785adaf7c6d8f39620d96161f3fccba9ce78', id: "skills", class: "skills tabbed" }, h("input", { key: '0c8a616474efa025a6ccd365f57d15622f3b9a4d', type: "radio", id: "tab1", name: "css-tabs", checked: true }), h("input", { key: 'ae1fb196fd50d39273c9dbe9a906ce82b988065f', type: "radio", id: "tab2", name: "css-tabs" }), h("input", { key: 'bcd39bc7644935bb22b00bef956941f3eeee109f', type: "radio", id: "tab3", name: "css-tabs" }), h("ul", { key: '305095d50d6c057679320ef5af70d0a0946b1aa9', class: "tabs" }, h("li", { key: 'cec32d329cf3df00b3218ca660dcfc4db950c4bb', id: "skillstab1", class: "tab -translate-y-28" }, h("label", { key: 'f16835faf460cf822e44cc215154e7cccccf8edf', htmlFor: "tab1" }, "Position Held")), h("li", { key: 'adb3efadab1a3ec8711868b23d53908b598e6688', id: "skillstab2", class: "tab -translate-y-28", onClick: () => this.playStack() }, h("label", { key: '647372fd38cacde108a6b060b367e5f7fe04fbe7', htmlFor: "tab2" }, "Stack")), h("li", { key: '28ad9ff354cf074efcc7413a8fb1694e3b69d227', id: "skillstab3", class: "tab -translate-y-28", onClick: () => this.playFuture() }, h("label", { key: '54319daeaa78607fc5ad642c548aeb6af408f0df', htmlFor: "tab3" }, "The Future"))), h("main", { key: '64da3ae629633577462d01cc8c81bac0d7084b27', id: "history", class: "tab-content" }, h("article", { key: '73efd8aac02bedad5d4d1dbef15ef655f845a27d', class: "tab-item h-[458px]" }, h("h3", { key: 'd2282df776d1f7448706410c52133e7632ebc792', class: "opacity-0" }, "Software Developer - Team Lead | Promotions & Retention Marketing"), h("h5", { key: 'aeed96a8e35529e587aa2a0272b1530058ac5c44', class: "opacity-0" }, "Osiris Trading \u00B7 Full-time"), h("h6", { key: '24771c045dfded9cd2b0b68c26bc85dd5f47e174', class: "opacity-0" }, "Nov 2021 - Present \u00B7 ", this.dateHandler('2021-11-01T10:00:00Z'), " "), h("div", { key: 'b0687809776339ee66a989632d77d97a42a74763', class: "mt-4 mb-3 divider bg-gradient-to-r from-indigo-700 via-40% via-transparent to-transparent -translate-[120%]" }), h("div", { key: '873f0b7ba5ab94cacb0b4359485397211ff2a633', class: "flex flex-col h-full justify-between" }, h("div", { key: '24b238c97cf02993a5472b2a02042aa299cee51f', id: "description", class: "description" }, h("p", { key: '8e822c8071a48ec91764cd98891f3877b648dfc7', "data-id": "1" }, "Building bespoke promotions focused on delivering engaging experiences for the global Betway Brand. Utilizing the latest technology to deliver fast, data efficient and visually stunning UI and UX projects. Working with a team of dedicated back-end and front-end engineers catering to both business and customer needs."), h("p", { key: '8cfb837dcfe1c823be6d180400b421d15fb5c490', "data-id": "2" }, "I am in charge of project planning, understanding business requirements and delivering above expected quality on project delivery whilst standardizing team's understanding to deliver similar results."), h("p", { key: '0b734d8b88ede9f68d129e7ecc6fa6bad24012ce', "data-id": "3" }, "Feel free to visit my ", h("a", { key: 'e92caae65ed9d98ef62ae5a3f62164167e068ad4', class: "text-indigo-700", href: "https://www.linkedin.com/in/craigddutoit/", target: "_blank" }, "LinkedIn Profile"), " for broader career experience.")), h("div", { key: '91711d5e66176bc31a115474688699f190c3b6d0', class: "requirements" }, h("h5", { key: '64a9134f19e5248273ddbec94a68cd07bf57ff3e' }, "Responsibilities:"), h("div", { key: '6b8713b1a1b81197243932952805a99ac15bb607', id: "responsibilities", class: "flex gap-1 flex-wrap" }, h("p", { key: '21a5b4061074930bc64bb230ea2bc9f2e55230e5', "data-id": "1" }, "Defining design"), h("p", { key: 'c76a5587ee2c377224322606050aefe1ecd8d1fa', "data-id": "2" }, "Developing Front-End"), h("p", { key: '1483d7b847eb14fdfadfc73f6c93964cf4fc7e48', "data-id": "3" }, "Collaboration on Design Refinement"), h("p", { key: '443bd7dfdb94962968c445994494a0403546ff14', "data-id": "4" }, "Collaboration on Back-end Data structures"), h("p", { key: 'b5b98f4ea81b77d37484760df49c0d450dd65b7f', "data-id": "5" }, "Project Planning"), h("p", { key: '99c27dda60586b98aeab7634373eb7d199cecf40', "data-id": "6" }, "Team Planning"), h("p", { key: 'c7a8791e10361f711d88710ff2b9e2b7493210a7', "data-id": "7" }, "Project Feedback sessions"), h("p", { key: '5afff5f0aa0da0afb782351e68d77db517891f44', "data-id": "8" }, "Ongoing support of live software"), h("p", { key: '501c0bc7b2c85ea1c183041faf0cfb9a08a4bd15', "data-id": "9" }, "Future Proofing Project Structures"), h("p", { key: 'c788284ea9c59aa2a6f590c50e117c9a12e524ba', "data-id": "10" }, "Creation & Maintenance of Front-End Brand UI"), h("p", { key: '60cfc0270cc975b3a2b9b8fa402734f9a64133ee', "data-id": "11" }, "Mentorship & Training")))))), h("main", { key: 'c05b866f525dc7149259664410ebc403163d1709', id: "stack", class: "tab-content flex flex-col gap-4 h-[458px]" }, h("article", { key: '94c2c957e439d92dfd79ecc5b661d018955b8c93', "data-id": "1", class: "tab-item w-full flex gap-6 items-center" }, h("div", { key: '6b63e06d80e574aee41d273f84d7cf002de71409', class: "item-title flex flex-col" }, h("h5", { key: '8f1c752858ae4991c33cb695d5534837db0b66c0' }, "StencilJS"), " ", h("span", { key: '521a56c7d849c3b1c139118f7afa48d5e3baa77a' }, "4 YEARS")), h("div", { key: 'a278eed16fa3a49cd64177976863887efe33b40a', class: "flex w-full flex-col gap-2" }, h("h6", { key: '6543d18cee7c9a876192bc73edf92bc3b6f25bc2' }, "Knowledge"), h("div", { key: '28ffd9490879794d3d103cdc0195e5b29b3add36', class: "progress-bar knowledge" }, h("div", { key: '825994a7531c414f967b8382cc91f7537a921971', "data-id": "1", "data-progress": "90", class: "progress" }))), h("div", { key: '0d2b78b443028ddffa4c8fc9f0ef382d53ff2ed4', class: "flex w-full flex-col gap-2" }, h("h6", { key: '0ba1cd53d9aedd7cf0efd829baa813f2e02bbf6d' }, "Love"), h("div", { key: '876fc27a67790a8d008a91dc6e24571d4a81d193', class: "progress-bar love" }, h("div", { key: '572b50d5893f83da958549602b411bc5f7cb2c48', "data-id": "1", "data-progress": "100", class: "progress" })))), h("article", { key: '822211995e83f301735e1a15a46bcfd9a822f194', "data-id": "2", class: "tab-item w-full flex gap-6 items-center" }, h("div", { key: '70fec77c428c86cf1142c0594cd9e5bb073b31d8', class: "item-title flex flex-col" }, h("h5", { key: '41ca0b1dacde4cfa99c11f9f00e0eb0d57ed45be' }, "React"), " ", h("span", { key: 'b7561e4a43e60e5de9d7c975c14f5b05bc75b0c4' }, "2 YEARS")), h("div", { key: '81b8916c4403022a563e2323008663e549cebac5', class: "flex w-full flex-col gap-2" }, h("h6", { key: '7a99dfead75702bb49f5edd6fe9e8058d72ace32' }, "Knowledge"), h("div", { key: '6b7cd78c9f383f6c3ebe4a4fcacdf7d4a15c97f5', class: "progress-bar knowledge" }, h("div", { key: '2e885cf48f2cf3a9c7dda4b2bfc250e5202dd6d2', "data-id": "2", "data-progress": "70", class: "progress" }))), h("div", { key: '52a993ab298bfae97166912aa9ebc2bd08567fa0', class: "flex w-full flex-col gap-2" }, h("h6", { key: 'ce7d1a02b902eef7db39af7b862e920f790e2d30' }, "Love"), h("div", { key: 'aa64f4e725605bb8f17dd0676956ba7575ee9c4d', class: "progress-bar love" }, h("div", { key: 'c5a74e4534dabd7250e4a8cf758622f8f8f73dbf', "data-id": "2", "data-progress": "90", class: "progress" })))), h("article", { key: '470a3a1c3f8ab0683074c840a29ec67f5f56fe73', "data-id": "3", class: "tab-item w-full flex gap-6 items-center" }, h("div", { key: 'cf488fb07947a28dd41bab8195bf390219d1c409', class: "item-title flex flex-col" }, h("h5", { key: '532a7d290983e0d604cdbbf68dc7d6d887794875' }, "Angular"), " ", h("span", { key: '9714b5675f4ee71c3b38d4b3961188491b14ad03' }, "2 YEARS")), h("div", { key: '93db19941cd0f87fd60e1392ce69a7562036ae87', class: "flex w-full flex-col gap-2" }, h("h6", { key: '40179ffcbe0bf31e74f2090ba843614c91aaab32' }, "Knowledge"), h("div", { key: 'b7eaeaf8b44f0fdbcc79adc3c135a50361184c09', class: "progress-bar knowledge" }, h("div", { key: '9cf6bb98b583e14c211355935f53eda8fdee5b4b', "data-id": "3", "data-progress": "70", class: "progress" }))), h("div", { key: '068b54f9597c747ab650e716c27cfeb9f65535f4', class: "flex w-full flex-col gap-2" }, h("h6", { key: 'b3700dd5fcc823612744bd79734c6003b60e0411' }, "Love"), h("div", { key: 'd9bf55c887fa57bc99eead92de088390037fab9c', class: "progress-bar love" }, h("div", { key: '4d32e98e2c3b988aacd93055b96be8c9c8ed80df', "data-id": "3", "data-progress": "70", class: "progress" })))), h("article", { key: '4994fead6c9261fe669511d06b0df9018dd65b82', "data-id": "4", class: "tab-item w-full flex gap-6 items-center" }, h("div", { key: '448ed0a77439369fe837a652ae64b030c000c009', class: "item-title flex flex-col" }, h("h5", { key: '09bca456df516bf23d906ac7406a7d048c0eeda2' }, "TypeScript"), " ", h("span", { key: '7c8aed6c03764ebd214104d37cc235616fdc53e7' }, "5 YEARS")), h("div", { key: 'f80e9f8ac09b8e62f74b6f6f2c01b27c799ff705', class: "flex w-full flex-col gap-2" }, h("h6", { key: '41d465aaf0eddbb8ef3ab6d0fd092a04effe6902' }, "Knowledge"), h("div", { key: '5785a3c8afdce504651766d9549b11b6f5f399cf', class: "progress-bar knowledge" }, h("div", { key: 'aff602b78ac0abf4cd6fabd189ad8efd06c46c26', "data-id": "4", "data-progress": "80", class: "progress" }))), h("div", { key: '01c4ab0c9097aa0dfc0ea9e0b413ec517870a892', class: "flex w-full flex-col gap-2" }, h("h6", { key: '70b6e929ef3c1d7ffafb44ab44770894c2a973a3' }, "Love"), h("div", { key: '71e74a556493b591d63a769d79ad8c9783113f63', class: "progress-bar love" }, h("div", { key: '4c66239bc85623aacf0410595e706191b6b63dec', "data-id": "4", "data-progress": "90", class: "progress" })))), h("article", { key: 'a46c3e39b2db17bf67b721adb1918330d797ab97', "data-id": "5", class: "tab-item w-full flex gap-6 items-center" }, h("div", { key: 'c9a493ef12ec3a04e527d967b4ebd8afc41163ba', class: "item-title flex flex-col" }, h("h5", { key: '39d12957041a64d76c97439ef7f9821a638227d2' }, "GSAP"), " ", h("span", { key: '14edd4fcbe90f5c60fa83f959847d3908e5458cf' }, "2 YEARS")), h("div", { key: '89da12b551149222cec1f7cccdf868f902aca8c8', class: "flex w-full flex-col gap-2" }, h("h6", { key: '1562123bb94da768b6c1a956a9ae7bf973d69492' }, "Knowledge"), h("div", { key: 'c3183e3163d8aa91a071ae406280d648bed20e15', class: "progress-bar knowledge" }, h("div", { key: 'caeabdb0b120ac004a3f0428dd2513fa1bff274c', "data-id": "5", "data-progress": "70", class: "progress" }))), h("div", { key: '51c73a8e195869336e9175390b5ce1bc769a3126', class: "flex w-full flex-col gap-2" }, h("h6", { key: '5cfdc3767288f42d04319e33f3a09df9251f4ebd' }, "Love"), h("div", { key: '518af1b7c0daf45a6158a369180b103c73d7d3f4', class: "progress-bar love" }, h("div", { key: 'dbe55877d0db505bb9f0f9030e9279dd5f2f2ca6', "data-id": "5", "data-progress": "100", class: "progress" })))), h("article", { key: '5023d95de5084405bd0f9561f41ce4265b53a7ae', "data-id": "6", class: "tab-item w-full flex gap-6 items-center" }, h("div", { key: 'f8dcea6f55f94306d262a1c4bf0208d59f5f12f9', class: "item-title flex flex-col" }, h("h5", { key: 'c1792f234d19f4d3a3b02d822c2b249e8457db5e' }, "TailwindCSS"), " ", h("span", { key: '946ce3be21c43f53cba9d4a48e54b9c72fec5502' }, "3 YEARS")), h("div", { key: '8498736883de0f916933706770a4fda90c5262e7', class: "flex w-full flex-col gap-2" }, h("h6", { key: 'c10d27eeff06f45c7658e9977978a751bde65adf' }, "Knowledge"), h("div", { key: '6f86d24e1d43f7c8e24170ebeaaf20b1f657f98f', class: "progress-bar knowledge" }, h("div", { key: '52628fe2a35588783f4290b638cabcf7d4e92d3f', "data-id": "6", "data-progress": "90", class: "progress" }))), h("div", { key: 'c5ef2ad6bc80940312e31b32b8ee928974a38c3c', class: "flex w-full flex-col gap-2" }, h("h6", { key: 'e40976b33d6f129963ce4ff5d610632662c0c193' }, "Love"), h("div", { key: '665e380283671996455d997e65b83dea1a463da0', class: "progress-bar love" }, h("div", { key: 'a52c073987b408029e80dd9f23bcb7d7afef81cb', "data-id": "6", "data-progress": "90", class: "progress" })))), h("article", { key: '874b7f68bf8fa26e9cf655a7ede65950309a586f', "data-id": "7", class: "tab-item w-full flex gap-6 items-center" }, h("div", { key: '990a16a73720565823330640852b1be3a7e55b79', class: "item-title flex flex-col" }, h("h5", { key: '8448027adc35612fb2a146bd393a141c58a61f23' }, "CSS"), " ", h("span", { key: 'd2a1911dc98ec1b0481a28d196325381018ead50' }, "15 YEARS")), h("div", { key: '0054912a648269a242867ac5399241c845c05aef', class: "flex w-full flex-col gap-2" }, h("h6", { key: 'a18463db3b34d99b6fe6562825a8cc12e4a97061' }, "Knowledge"), h("div", { key: '63c4dcd251556b50fc2d7ced04d50e39db41e5fa', class: "progress-bar knowledge" }, h("div", { key: 'f5be975a61f7c69dd60446f8816d792f03d67ab8', "data-id": "7", "data-progress": "100", class: "progress" }))), h("div", { key: '080db77cd806a15026ebfe0bc86ae79d0498f58b', class: "flex w-full flex-col gap-2" }, h("h6", { key: '32540683acfd591c5bf38f25808df828a580f80a' }, "Love"), h("div", { key: 'ce198c9c3659eb279661481a07fc55aed3f2d0ab', class: "progress-bar love" }, h("div", { key: '0dfb446382fcef0efcc49072f27acc7bb199e5cf', "data-id": "7", "data-progress": "100", class: "progress" })))), h("article", { key: '7a88e883ed1ecef01cf966ba12c0d8edff75a19c', "data-id": "8", class: "tab-item w-full flex gap-6 items-center" }, h("div", { key: '2d3e3a71134cc8ca87ae5bd8f568b5af10820b1c', class: "item-title flex flex-col" }, h("h5", { key: '1b500d6c784d9fe6f0a5024aa21c5491c499aa03' }, "Git"), " ", h("span", { key: '08f6ed8592a5c06d732ec0359ec7efa41f07d640' }, "15 YEARS")), h("div", { key: '166f9ed3b99c300368f00c1cabe66d3d2741f50f', class: "flex w-full flex-col gap-2" }, h("h6", { key: '5e9f3994dab599418ee6870e9fd30c664cf48233' }, "Knowledge"), h("div", { key: '5d954941d02bb7cfefe1e23dee2495345dfbb324', class: "progress-bar knowledge" }, h("div", { key: '8f7d14874a8ad57ef436dad40bc4f144eec158a0', "data-id": "8", "data-progress": "80", class: "progress" }))), h("div", { key: 'a0bf45bbcade453c5edf09438c865af2b36a5c70', class: "flex w-full flex-col gap-2" }, h("h6", { key: '2b44392da4a0dc81cd26c8c9c97c1dd98a71f641' }, "Love"), h("div", { key: '101954c052138cc00887273c45b7fd6b56ceb03d', class: "progress-bar love" }, h("div", { key: '929558389a9fe1fcb62eb36ce42beb687b321100', "data-id": "8", "data-progress": "100", class: "progress" }))))), h("main", { key: '64ec5a2d5301fbd363253ea9b2066356bb9a28a8', id: "future", class: "tab-content" }, h("article", { key: 'b63bbd56e86f9735f54f17af2fb5d8bf3f06c655', class: "tab-item" }, h("p", { key: '62c0f33b88a2c76477d29620ac029e2ac7ef452a', "data-id": "1" }, "I would not neccessarily say I am open to all offers when it comes to employment, I simultaneuosly enjoy what I do and where I am doing it which seems to be a rare thing these days, and therefore I have that wonderful luxury in being able to choose comfortably what comes next."), h("p", { key: 'd0b1519e550c2b7ec86205c788bc2c4c9955f20d', "data-id": "2" }, "With that being said, my mind does wander to what may lie for me out there, to what challenges await, perhaps an exciting endeavor, perhaps amazing people with enough passion about what they do that one can hardly pass up the offer."), h("p", { key: '9002353cd01b81aa64a116df6fc593186442134e', "data-id": "3" }, "I believe in brands and business built on the love of the game, numbers are a conversation of course, but that passion for what you do and who you do it with... that makes one dream of waking up to the work ahead."), h("p", { key: 'ef9547227b29ff31f5046d762ae2fa9134c3216f', "data-id": "4" }, "Please feel free to contact me to discuss your passion and vision."), h("p", { key: '9cbaf9a8d27d16b9b230db2fd1793e9e5936ea84', "data-id": "5" }, "Mail me ", h("a", { key: '53df5516d10524f02e6c55a5daef19af6f4f09ed', href: "mailto: craigtoit@gmail.com", class: "text-indigo-700" }, "craigtoit@gmail.com"), "."))))), h("div", { key: '38e4509109f4095d80fce451702a38c70c1ab910', id: "logo", class: "logo opacity-0 absolute w-full z-0" }, h("img", { key: '6521362eed7d8e98fda1a1dc32986847c04c2ea8', class: "absolute -left-[278px]", src: "./assets/logo.png", alt: "" })), h("div", { key: '89dba662174c3a5c1aa75f972b8f698967a7bebf', id: "circles", class: "concentric w-full h-screen absolute z-0" }, h("div", { key: '8c722aaed73cb3cf893bd43449c22f6481c48714', id: "circle-1" }), h("div", { key: '17cb9801815871b6d797e52d68c3567641ba83c2', id: "circle-2" }), h("div", { key: '7870a55ec522d7127debfb5d3cca9969627584c0', id: "circle-3" }), h("div", { key: '7650a19620dc3a2a82193f013c380a5615f7a0fd', id: "circle-4" })), h("article", { key: '4ad338f90044f7b852c42059021e28d46fd1f208', id: "intro", class: "intro-actions flex flex-col absolute m-auto" }, h("p", { key: 'a36086237103615aba8c8ebed04f89eaa897589f', class: "intro-text", id: "intro-1" }, "Well, what do we have here.... I don't recognize you, how did you get here?"), h("p", { key: '454123eacb90e37539723d4f7f09f97c91fe50b1', class: "intro-text", id: "intro-2" }, "I suppose the creator wanted you to be here, as far as I know he doesn't tell people about this place."), h("p", { key: '680e705f69b5153f87186503b73e392cd0a2cb34', class: "intro-text", id: "intro-3" }, "Whatever the case may be, the creator wanted you to be here. I guess we should have a look around."), h("div", { key: '9e964cd71b0f806da2b2afabd502e96c17984137', id: "look", class: "look w-full", onClick: () => this.launchCV() }, h("svg", { key: 'efa78665282ac520b3d55d2f84d3850d78bbe60d', class: "mx-auto mt-8", xmlns: "http://www.w3.org/2000/svg", width: "112", height: "112", viewBox: "0 0 32 32" }, h("g", { key: 'e6b31aa14be34e9d9d4ff2264e3ae7ba445fb73a', fill: "#ececec" }, h("path", { key: '996eca2aceceac885e9cc5cc6f157bc3f452a2d1', d: "M21 16a5 5 0 1 1-9.643-1.86a2 2 0 1 0 2.784-2.784A5 5 0 0 1 21 16" }), h("path", { key: 'a3a9163e7e114d7d202292ec17e8286afd81e27b', d: "M15.984 24.969a8.984 8.984 0 1 0 0-17.97a8.984 8.984 0 0 0 0 17.97m0-2a6.984 6.984 0 1 1 0-13.97a6.984 6.984 0 0 1 0 13.97" }), h("path", { key: '060ede373aa89bd8dc0dc7f970093512f3087e38', d: "M16.156 30.313c7.819 0 14.157-6.338 14.157-14.157C30.313 8.338 23.975 2 16.156 2C8.338 2 2 8.338 2 16.156s6.338 14.157 14.156 14.157m0-2C9.443 28.313 4 22.87 4 16.156C4 9.443 9.443 4 16.156 4s12.157 5.443 12.157 12.156s-5.443 12.157-12.157 12.157" }))))), h("p", { key: '8e78e8c8b9449d3e902e60cbeb8e30a74cb8b9bc', id: "footer", class: "footer absolute text-lg mx-auto w-fit h-fit font-sans" }, "Hand built with StencilJS + GSAP + Tailwind CSS \u00A0 [ ", h("span", { key: '12e98430733376be3af0487158099200279da974', onClick: () => this.resetThisPlace() }, "Restart the journey"), " ]")));
    }
    componentDidLoad() {
        ...
        gsapWithCSS.fromTo(this.look, { opacity: 0, y: 140 }, { opacity: 1, y: 0, duration: 2, delay: 14, ease: "expoScale" });
        // end
        gsapWithCSS.fromTo(this.circle1, { scale: 0.9 }, { scale: 1.1, duration: 2, yoyo: true, ease: "ease", delay: 2, repeat: -1, repeatDelay: 6 });
        gsapWithCSS.fromTo(this.circle2, { scale: 0.9 }, { scale: 1.1, duration: 2, yoyo: true, ease: "ease", delay: 2.5, repeat: -1, repeatDelay: 6 });
        gsapWithCSS.fromTo(this.circle3, { scale: 0.9 }, { scale: 1.1, duration: 2, yoyo: true, ease: "ease", delay: 3, repeat: -1, repeatDelay: 6 });
        gsapWithCSS.fromTo(this.circle4, { scale: 0.9 }, { scale: 1.1, duration: 2, yoyo: true, ease: "ease", delay: 3.5, repeat: -1, repeatDelay: 6 });
    }
